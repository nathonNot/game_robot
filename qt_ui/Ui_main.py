...
class Ui_main(object):
    def setupUi(self, main):
        ...
        self.bt_start_up.setGeometry(QtCore.QRect(240, 240, 75, 31))
        self.bt_start_up.setObjectName("bt_start_up")
        self.bt_stop = QtWidgets.QPushButton(main)
        self.bt_stop.setGeometry(QtCore.QRect(330, 240, 75, 31))
    ...
    def retranslateUi(self, main):
        ...
        self.bt_stop.setText(_translate("main", "停止"))
